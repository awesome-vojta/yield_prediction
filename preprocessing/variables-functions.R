...
INDEX_CLIP_FOLDER  <- "preprocessing/out/"
FILTERED_FOLDER    <- "preprocessing/cache/"
INTERPOLATE_FOLDER <- "preprocessing/cache/"
MASK_FOLDER        <- "preprocessing/in/"
CLIP_FOLDER        <- "preprocessing/out/"
ALIGNED_FOLDER     <- "preprocessing/cache/"

A_EVI  <- "preprocessing/in/a_EVI.tif"
S_EVI  <- "preprocessing/in/s_EVI.tif"
A_NDVI <- "preprocessing/in/a_NDVI.tif"
S_NDVI <- "preprocessing/in/s_NDVI.tif"
